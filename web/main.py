...
<div class="box">
  <div style="display:flex;align-items:center;justify-content:center;gap:10px;margin-bottom:4px">
        ...
        <h1>NDBot v1.01.0512</h1>
      </div>
  <p style="color:#666;font-size:11px;margin-bottom:4px">v1.01.0512 · by AiPo</p><p>请输入访问密码</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>NDBot v1.01.0512 控制台</title>
<style>
[data-theme="dark"]{
